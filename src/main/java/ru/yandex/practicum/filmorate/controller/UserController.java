...
public class UserController {
    ...
    /**
     * Добавляет пользователя {@code friendId} в список друзей пользователя {@code id}.
     * Дружба односторонняя: у {@code friendId} пользователь {@code id} в друзья не добавляется.
     *
     * @param id       идентификатор пользователя, добавляющего друга
    ...
    /**
     * Удаляет связь дружбы между двумя пользователями у одной стороны.
     *
