...
public class User {
    ...
    /**
     * Идентификаторы друзей пользователя. Дружба односторонняя: если пользователь
     * добавляет кого-то в друзья, это не делает его другом в обратную сторону —
     * связь появляется только в списке инициатора.
     */
